...
<html>
	...
	<body>
		...
		<c:forEach var="str" items="${mylist}" varStatus="status"> <!-- 하나씩 꺼내 str에 담는다 -->
		...
		<h2>varStatus.index : 0에서부터 시작하는 반복문의 반복 횟수</h2>
		<h2>varStatus.count : 1에서부터 시작하는 반복문의 반복 횟수</h2>
		...
		<c:forEach var="i" begin="0" end="100" step="5"> <!-- step : 건너뛰기 -->
			<b> ${ i } </b>
		</c:forEach>
		<hr>
