...
<html>
	<head>
		...
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script> <!-- jquery cdn 달기 -->
	</head>
	<body>
		<h1>회원 아이디 중복 체크</h1>
		...
		$(document).ready(function() {
			$("#btn3").click(function() {
				...
				$.post(
						...
						, { mid:$("#mid").val() } //mid를 보낼 건데, 위에 설정한 mid에 들어 있는 val 값을 보낼 거야.
						, function(data, status) {
							...
							if(data < 1) {//중복 아님
								...
								$("#id_message").text("잠시 후 다시 시도해주세요.");
								$("#id_message").css("color", "red");
							}
						}//function
				);//post
